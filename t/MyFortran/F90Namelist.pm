...
package MyFortran::F90Namelist;

=head1 NAME

MyFortran::F90Namelist - Parse F90 namelists into hash and export in different formats

=head1 SYNOPSIS

  use MyFortran::F90Namelist;
  my $nl = MyFortran::F90Namelist->new() or die "Couldn't get object\n";
...
Merge two namelists
  ...
  my $nl2 = MyFortran::F90Namelist->new() or die "Couldn't get object\n";
...
MyFortran::F90Namelist is a module for parsing MyFortran90 namelists into hashs and
...
Generally speaking, L<MyFortran::F90Namelist::Group|MyFortran::F90Namelist::Group>
...
See L<MyFortran::F90Namelist::Group|MyFortran::F90Namelist::Group> for a more
...
L<MyFortran::Namelist> by Victor Marcello Santillan.
...
# my $nl = MyFortran::F90Namelist::new(name => 'toto', empty => 1);
# my $nl = MyFortran::F90Namelist::new({name => 'toto', empty => 1});
# IMPLEMENT US:
# my $nl = MyFortran::F90Namelist::new({file => $filename);
# my $nl = MyFortran::F90Namelist::new({text => $text, debug => 1});
#
    ...
    my $short_usage =
        "Usage:\n" .
        "  MyFortran::F90Namelist::new()\n" .
        "  MyFortran::F90Namelist::new(name => \$name)\n" .
        "  MyFortran::F90Namelist::new({name => \$name})\n" ;
...
#
    ...
    if ($debug) {
	print STDERR
	  "MyFortran::F90Namelist->parse: Successfully read namelist <$name>\n";
	print STDERR "=================================\n";
    }
...
#
    ...
    my (@slots2,$hashref2);
    if (ref($nl2) eq 'MyFortran::F90Namelist') {
        @slots2   = @{$nl2->{SLOTS}};
        $hashref2 = $nl2->{DATA};
        ...
        croak "MyFortran::F90Namelist->merge(): "
          . "expected MyFortran::F90Namelist object or hashref\n";
    }
