...
%run = (
  ...
  'molpro',          0,  # do SCF calculations using MOLPRO (necessary for UKRmol+ codes)
  'psi4',            1,  # another alternative to MOLPRO, choose one or other
  ...
  'rmt_interface',   1,  # form the RMT molecular input file (rmt_interface and photoionization are mutually exclusive options)
  ...
  'only',            "target-scatci_integrals|target-congen|target-scatci|target-denprop|scattering-congen|scattering-scatci|scattering-cdenprop_all|scattering-rmt_interface",
