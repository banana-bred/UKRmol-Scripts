...
%model = ( 
  ...
  'molecule',   "CH4+",              # Used only for directory and descriptions
  'atoms',  ["C","H","H","H","H"],   # All atoms must be specified
  'nelectrons',      9,              # number of target electrons
  'symmetry',     "D2",              # Options are "D2h", "C2v", "C2", "Cs", "C2h", "D2", "Ci", "C1"
  ...
  'active_orbs',   [2,2,2,2,0,0,0,0], # which orbitals for each symmetry to use as active, 
  'virtual_orbs',  [0,0,0,0,0,0,0,0], # which orbitals for each symmetry to use as virtual, 
  'reference_orbs',[3,3,3,3,0,0,0,0], # which orbitals for each symmetry to use for searching reference orbitals, 
  ...
  'ncasscf_states', {'doublet', [0,1,1,1,0,0,0,0],
  ...
  'ntarget_states', {'doublet', [1,1,1,1,0,0,0,0],  # number of target states to calculate in each irreducible representation (IR)
                     'quartet', [0,0,0,0,0,0,0,0]},
  'ntarget_states_used', "4",         # number of target states which will be actually used in scattering calculations 
  ...
  'scattering_states', {'singlet', [1,1,1,1,0,0,0,0], # 1/0 to run/not to run scattering calculation for a given spin-symmetry
 ...
 # Initial and final states for which the cross sections are calculated
  ...
  'first_Ip',         13.6,              # first ionization potential (used by dipelm only) - units set by e_unit
