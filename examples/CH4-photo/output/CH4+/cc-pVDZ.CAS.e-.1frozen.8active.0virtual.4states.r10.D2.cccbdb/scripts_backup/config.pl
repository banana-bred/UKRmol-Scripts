...
%run = (
  ...
  # Running options
  # Which codes will you run? 
  'ukrmolplus',      1,  # UKRmol+: use new codes for integration etc.
  'molpro',          1,  # do SCF calculations using MOLPRO (necessary for UKRmol+ codes)
  'psi4',            0,  # another alternative to MOLPRO, choose one or other
  # What type of calculation/process?
  'scattering',      1,  # run all programs, if you want to run target only, set to 0
  'photoionization', 1,  # calculate photoionization cross sections of the (N+1)-electron system instead of electron scattering cross sections
  ...
  'run_eigenp',      0,  # calculate eigenphase sums for all symmetries
  'run_tmatrx',      0,  # calculate T-matrices for all symmetries
  'run_ixsecs',      0,  # calculate cross sections for all symmetries
  ...
  'only',            "target-scatci_integrals|target-congen|target-scatci|target-denprop|scattering-congen|scattering-scatci|scattering-cdenprop|scattering-swinterf|scattering-rsolve|scattering-dipelm",
