...
%model = ( 
  ...
  'basis',         "6-31Gxx",         # make sure there are corresponding files in $dir_basis (see below)
  ...
  'active_orbs',   [3,1,1,0,2,1,1,0], # which orbitals for each symmetry to use as active, 
  ...
  'ntarget_states', {'singlet', [6,2,2,1,2,1,1,0],  # number of target states to calculate in each irreducible representation (IR)
                     'triplet', [0,0,0,0,0,0,0,0]},
  'ntarget_states_used', "15",        # number of target states which will be actually used in scattering calculations 
  ...
  'delthres',      ["2.0D-07", "2.0D-07", "2.0D-07", "2.0D-07", "2.0D-07", "2.0D-07", "2.0D-07", "2.0D-07"],
  ...
  'use_PCO',               1,                 # do you want to use a Gaussian type PCO basis?
  'reduce_PCO_CAS',        0,                 # == 0, off, target CSFs containing PCOs only use CAS^N-1 PCO^1 ; ==1, on, target CSFs containing PCOs only use GS^N-1 PCO^1.
  'maxl_PCO',              2,                 # the highest partial wave used in the PCO Gaussian basis
  'PCO_alpha0',   [0.17,0.17,0.17],           # Alpha0 parameter for PCO generation, one per PCO partial wave.
  'PCO_beta',     [1.4 ,1.4 ,1.4 ],           # Beta parameter for PCO generation, one per PCO partial wave.
  'num_PCOs',     [10  ,10  ,6   ],           # Number of PCO functions generated per PCO partial wave.
  ...
  'PCO_delthres',      ["2.0D-04", "2.0D-04", "2.0D-04", "2.0D-04", "2.0D-04", "2.0D-04", "2.0D-04", "2.0D-04"],
 ...
 # Initial and final states for which the cross sections are calculated
  ...
  'positron_flag',       1,             #0 for electron scattering, 1 for positron scattering 
