...
%model = ( 
  ...
  'model',          "ORMAS-CAS-C",    # options are "SE"    = static-exchange, 
                                      #             "SEP"   = SE + polarization, 
  ...
  'l2_MAS', [
    [1,0,0,0,0,0,0,0], [2,2], # These orbitals are frozen
    [5,1,0,0,0,0,0,0], [7,9], # Here we allow double excitations out of the CAS.
    [5,0,0,0,0,0,0,0], [0,2], # CAS-C model - excitations to virtual orbitals
  ],
