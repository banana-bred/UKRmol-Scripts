...
%model = ( 
  ...
  'model',          "ORMAS-SEP",      # options are "SE"    = static-exchange, 
                                      #             "SEP"   = SE + polarization, 
  ...
  'nreference',    7,                 # number of orbitals used for searching reference orbitals
  ...
  'active_orbs',   [3,1,0,0,0,0,0,0], # which orbitals for each symmetry to use as active, 
  ...
  'MAS', [
    [1,0,0,0,0,0,0,0], [2,2], # These orbitals are frozen
    [3,1,0,0,0,0,0,0], [8,8], # as are these.
  ],
  ...
  'l2_MAS', [
    [1,0,0,0,0,0,0,0], [2,2],
    [3,1,0,0,0,0,0,0], [6,8], # 
    [6,1,0,0,0,0,0,0], [0,2], # Virtual orbitals
  ], 
  ...
  'nescat',      "60, 400",              # number of input scattering energies in each subrange (input for R_SOLVE via namelist &rslvin)
  'einc',     "0.01,0.1, 7.01, 0.02",              # scattering energies - initial energy, energy increment, there can be more subranges
