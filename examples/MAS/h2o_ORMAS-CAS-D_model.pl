...
%model = ( 
  ...
  'model',          "ORMAS-CAS-D",    # options are "SE"    = static-exchange, 
                                      #             "SEP"   = SE + polarization, 
  ...
  'MAS', [
    ...
    [5,1,0,0,0,0,0,0], [7,8], # Here we have 8 electrons in 6 orbitals CAS(8,6)
    [5,0,0,0,0,0,0,0], [0,1], # new CAS-D model - equivalent to CAS-C for scattering run.
  ],
