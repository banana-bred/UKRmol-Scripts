...
%model = ( 
  ...
  'model',          "GASSCF-test",    # options are "SE"    = static-exchange, 
                                      #             "SEP"   = SE + polarization, 
  ...
  'use_MASSCF' , 2, # == 0, don't use MASSCF approach. == 1, use ORMASSCF in Molpro.  == 2, use GASSCF in Molcas.
  ...
  'MAS', [
    [1,0,0,0,0,0,0,0], [2,2], "inactive",  # These orbitals are closed
    [3,1,0,0,0,0,0,0], [6,10], "active",     # HF when fully occupied ( These 2 subspaces together
    [2,0,0,0,0,0,0,0], [10,10], "active",     # rest of the CAS          are equivalent to CAS(8,6) )
  ],
