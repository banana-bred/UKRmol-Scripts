...
%model = ( 
  ...
  'model',          "ORMASSCF-test",  # options are "SE"    = static-exchange, 
                                      #             "SEP"   = SE + polarization, 
  ...
  'use_MASSCF' , 1, # == 0, don't use MASSCF approach. == 1, use ORMASSCF in Molpro.  == 2, use GASSCF in Molcas.
  ...
  'MAS', [
    ...
    [3,1,0,0,0,0,0,0], [0,8], "active",     # HF when fully occupied ( These 2 subspaces together
    [2,0,0,0,0,0,0,0], [0,4], "active",     # rest of the CAS          are equivalent to CAS(8,6) )
  ],
