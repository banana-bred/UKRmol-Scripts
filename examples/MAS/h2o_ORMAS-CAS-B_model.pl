...
%model = ( 
  ...
  'model',          "ORMAS-CAS-B",    # options are "SE"    = static-exchange, 
                                      #             "SEP"   = SE + polarization, 
  ...
  'l2_MAS', [
    [1,0,0,0,0,0,0,0], [2,2], # These orbitals are frozen
    [5,1,0,0,0,0,0,0], [8,9], # Here we allow single excitation out of the CAS
    [5,0,0,0,0,0,0,0], [0,1], # CAS-B model - excitations to virtual orbitals
  ],
